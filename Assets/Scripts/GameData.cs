...
public class GameData
{
    static public List<SkillSelectTable> SkillSelectTables = new List<SkillSelectTable>()
    {
       ...
       new SkillSelectTable(){Type = WeaponType.Weapon, Id = 1, Name = "魔法の杖", Level= 0, Probability = 20},
       ...
       new SkillSelectTable(){Type = WeaponType.Weapon, Id = 6, Name = "ハニワ", Level = 0, Probability= 30},
       new SkillSelectTable(){Type = WeaponType.EffectWeapon, Id = 0, Name = "体力アップ", Level= 0, Probability = 40},
       new SkillSelectTable(){Type = WeaponType.EffectWeapon, Id = 1, Name = "生成数", Level= 0, Probability = 50},
       new SkillSelectTable(){Type = WeaponType.EffectWeapon, Id = 2, Name = "磁石", Level= 0, Probability = 60},
       new SkillSelectTable(){Type = WeaponType.EffectWeapon, Id = 3, Name = "移動速度", Level= 0, Probability = 30},
       new SkillSelectTable(){Type = WeaponType.EffectWeapon, Id = 4, Name = "回復", Level= 0, Probability = 10},
    };
}
