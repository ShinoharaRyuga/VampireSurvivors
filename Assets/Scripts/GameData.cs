...
public class GameData
{
    ...
    {
       new SkillSelectTable(){Type = WeaponType.Weapon, Id = 0, Name = "ナイフ", Level = 0, Probability = 90 },
       new SkillSelectTable(){Type = WeaponType.Weapon, Id = 1, Name = "魔法の杖", Level= 0, Probability = 80},
       ...
       new SkillSelectTable(){Type = WeaponType.Weapon, Id = 4, Name = "オノ", Level= 0, Probability = 0},
       ...
       //new SkillSelectTable(){Type = WeaponType.EffectWeapon, Id = 1, Name = "威力", Level= 0, Probability = 80},
