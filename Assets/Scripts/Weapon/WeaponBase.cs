...
public abstract class WeaponBase : MonoBehaviour, IPause
{
    ...
    public void GameObjectGenerator()
    {
        ...
        var generateNumber = _generateNumber + GameManager.Instance.Player.CharacterStatusArray[4];     //生成数
    ...
    public void Attack(Collider2D hitCollider, bool destroyFlag)
    {
        if (hitCollider.CompareTag("Enemy"))
        {
            ...
            enemy.GetDamage(_damage + (int)GameManager.Instance.Player.CharacterStatusArray[4]);
